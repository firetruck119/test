...
@Data
public class PlatformUnconstrainedEntity {
    private String no;
    private String ver;
    private String xmmc;
    private String zjxh;
    ...
    public Map<String, String> takeMapForCheckPDF() {
        ...
        Double fw1y = 0.613 * 1.7 * a1z * vmin * vmin ;
        String p1;
        if ( fw1y < 400 ) {
            p1 = "<" ;
        } else if ( fw1y == 400 ) {
        ...
        Double fw2y = 0.613 * 1.7 * a2z * vmin * vmin ;
        String p2;
        if ( fw2y < 400 ) {
            p2 = "<" ;
        } else if ( fw2y == 400 ) {
...
//      最大横向位移风速计算
        ...
        Double v1s=sqrt(fw1 / 0.613 / 1.7 / a1z);
...
//      最大纵向位移风速计算
        ...
        Double v2s=sqrt(fw2 / 0.613 / 1.7 / a2z);
