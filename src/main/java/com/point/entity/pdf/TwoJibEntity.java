...
//基臂
            ...
            Double mz = mslza + mshlza + mza1 + mza2 + mza3 + mza4 + mza5 + mza6 + mza7;
            Double sz = 1000 * mz / dbwx;
            Double mw = mslwa + mshlwa + mwa1 + mwa2 + mwa3 + mwa4 + mwa5 + mwa6 + mwa7;
            ...
            Double mzi = mslzai + mshlzai + mza1i + mza2i + mza3i + mza6i + mza7i;
            Double szi = 1000 * mzi / dbwxi;
            Double mwi = mslwai + mshlwai + mwa1i + mwa2i + mwa3i + mwa6i + mwa7i;
            ...
            Double mzii = mslzaii + mshlzaii + mza1ii + mza2ii + mza3ii + mza7ii;
            ...
            Double fx3 = tz * dbld3 * (dbld3 - dblx3) * (dbld3 - dblx3) / 3 / 210000 / dbixii;
...
//    }
    ...
    public Map<String, String> takeStringMapForPdf(String type) {
        ...
        Double f = fx1 + fx2 + fx3 + o2 * dbhd2 + o3 * dbhd3 ;
