...
//        对接法兰螺栓拉力校核
        ...
        Double flslp = dbhflnlsyjlxs * flsl ;
        Double flslpk = flslp / 1000 ;
        map.put("mhflq", mhflq);
        map.put("mhflw", mhflw);
        map.put("flslh", flslh);
        map.put("flsll", flsll);
...
//螺栓对法兰压力校核
        ...
        Double flsyjp = dbhflnlsyjlxs * flsyj ;
        Double flsyjpk = flsyjp / 1000 ;
        map.put("fhflw", fhflw);
        map.put("flsyj", flsyj);
        map.put("flsyjp", flsyjp);
        map.put("flsyjpk", flsyjpk);

        //螺栓拧紧力矩计算
        Double flss = Math.max(flslp,flsyjp) ;
    ...
    public Map<String, String> takeStringMapForPdf(String type) {
        ...
        Double flslp = doubleMap.get("flslp");
        String dbhflb1 = takeSignByCompareNumber(flslp,dbhflflsp);
        String dbhflm1 = takeStringByCompareNumber(flslp,dbhflflsp);
        map.put("dbhflb1", CommonFunc.convertDoubleToString(dbhflb1));
        map.put("dbhflm1", CommonFunc.convertDoubleToString(dbhflm1));

        Double flsyjp = doubleMap.get("flsyjp");
        String dbhflb2 = takeSignByCompareNumber(flsyjp,dbhflflsp);
        String dbhflm2 = takeStringByCompareNumber(flsyjp,dbhflflsp);
