...
//基臂
        ...
        Double mwa8 = 250 * 1.25 * acx8db * lx8 ;
        Double mwa9 = 250 * 1.25 * acx9db * lx9 ;
        map.put("mslwa", mslwa);
...
//        一臂
        ...
        Double mwa8i = 250 * 1.25 * acx8db * lx8i ;
        Double mwa9i = 250 * 1.25 * acx9db * lx9i ;
...
//        二臂
        ...
        Double mwa8ii = 250 * 1.25 * acx8db * lx8ii ;
        Double mwa9ii = 250 * 1.25 * acx9db * lx9ii ;
...
//        三臂
        ...
        Double mslwaiii = 250 * 1.25 * aslcx * lslxiii ;
        Double mshlwaiii = 250 * 1.25 * ashlcx * lshlxiii ;
        Double mwa1iii = 250 * 1.25 * acx1 * lx1iii ;
        Double mwa2iii = 250 * 1.25 * acx2 * lx2iii ;
        Double mwa3iii = 250 * 1.25 * acx3 * lx3iii ;
        Double mwa8iii = 250 * 1.25 * acx8db * lx8iii ;
        Double mwa9iii = 250 * 1.25 * acx9db * lx9iii ;
        ...
        Double mslwaiv = 250 * 1.25 * aslcx * lslxiv ;
        Double mshlwaiv = 250 * 1.25 * ashlcx * lshlxiv ;
        Double mwa1iv = 250 * 1.25 * acx1 * lx1iv ;
        Double mwa2iv = 250 * 1.25 * acx2 * lx2iv ;
        Double mwa3iv = 250 * 1.25 * acx3 * lx3iv ;
        Double mwa9iv = 250 * 1.25 * acx9db * lx9iv ;
