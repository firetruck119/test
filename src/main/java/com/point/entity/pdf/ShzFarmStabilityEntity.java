...
//    private String wdlyp3;//有无运行机构
    ...
    public Map<String, String> takeMapForPDF(String type) {
        ...
        map.put("jzmzj", CommonFunc.convertDoubleToString(jzmzj));
...
//        map.put("mgq", mgq);
            ...
            Double mkhz = mhz9 + mhz10 + mhz11 + mhz12 + mhz13 + mhz14 + mhz15 + mhz16 + mhz17 + mhz18 + mhz19 + mhz21 ;
            Double vmab = jzmzj * 10 * ( lg - lqg9 ) / 2 / lg ;
            Double vmcd = jzmzj * 10 * lqg9 / 2 / lg ;
            Double mfhz = mqhz - mkhz ;
            Double dtvgx = mfhz * Math.sin( Math.PI / 4 ) / ll / 2 ;
            Double dtvgy = mfhz * Math.cos( Math.PI / 4 ) / lg / 2 ;
            Double dtvx2 = msq * Math.cos( Math.PI / 4 ) / ll / 2 ;
    ...
    public Map<String, String> takeStringMapForPdf(String type) {
        ...
        if (xljzsyModel.equals("常规工况")) {
            ...
            map.put("wdlym1", CommonFunc.convertDoubleToString("/"));
        }
        ...
        if (xljzsyModel.equals("常规工况")) {
            map.put("wdlym2", CommonFunc.convertDoubleToString(wdlym1));
        }else  if (xljzsyModel.equals("静载试验")) {
            map.put("wdlym2", CommonFunc.convertDoubleToString("/"));
        }
