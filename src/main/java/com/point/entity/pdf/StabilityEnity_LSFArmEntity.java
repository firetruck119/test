...
//    private Double lhzf15;
    ...
    private Double wddzxs7;

    //Select
    private String typeOfMachine;//机型
    private String typeOfRunningGear;//运行机构
//    private String typeOfPin;
//    private String levelOfPin;
    private String typeOfBolt;//地脚螺栓
    private String typeOfLifting;//起升机构
    private String typeOfGRU;//GRU
    ...
    private Map<String, String> createMap() {
        ...
        result.put("lbpx", CommonFunc.convertDoubleToString(lbpx));
...
//        result.put("nwdt", CommonFunc.convertDoubleToString(nwdt));
        ...
        result.put("jzwts", CommonFunc.convertDoubleToString(jzwts));
        result.put("jzmzj", CommonFunc.convertDoubleToString(jzmzj));
        ...
        result.put("lhz16", CommonFunc.convertDoubleToString(lhz16));
        result.put("lhz17", CommonFunc.convertDoubleToString(lhz17));
        result.put("lhz18", CommonFunc.convertDoubleToString(lhz18));
        result.put("lhz19", CommonFunc.convertDoubleToString(lhz19));
        result.put("lhz20", CommonFunc.convertDoubleToString(lhz20));
        result.put("lhz21", CommonFunc.convertDoubleToString(lhz21));
        ...
        result.put("lql16", CommonFunc.convertDoubleToString(lql16));
        result.put("lql17", CommonFunc.convertDoubleToString(lql17));
        result.put("lql18", CommonFunc.convertDoubleToString(lql18));
        result.put("lql19", CommonFunc.convertDoubleToString(lql19));
        result.put("lql20", CommonFunc.convertDoubleToString(lql20));
        result.put("lql21", CommonFunc.convertDoubleToString(lql21));
        ...
        result.put("hg16", CommonFunc.convertDoubleToString(hg16));
        result.put("hg17", CommonFunc.convertDoubleToString(hg17));
        result.put("hg18", CommonFunc.convertDoubleToString(hg18));
        result.put("hg19", CommonFunc.convertDoubleToString(hg19));
        result.put("hg20", CommonFunc.convertDoubleToString(hg20));
        result.put("hg21", CommonFunc.convertDoubleToString(hg21));

        result.put("lslmz", CommonFunc.convertDoubleToString(lslmz));
        result.put("lshlmz", CommonFunc.convertDoubleToString(lshlmz));
        result.put("lmz1", CommonFunc.convertDoubleToString(lmz1));
        result.put("lmz2", CommonFunc.convertDoubleToString(lmz2));
        result.put("lmz3", CommonFunc.convertDoubleToString(lmz3));
        result.put("lmz4", CommonFunc.convertDoubleToString(lmz4));
        result.put("lmz5", CommonFunc.convertDoubleToString(lmz5));
        result.put("lmz6", CommonFunc.convertDoubleToString(lmz6));
        result.put("lmz7", CommonFunc.convertDoubleToString(lmz7));
        result.put("lmz8", CommonFunc.convertDoubleToString(lmz8));
        result.put("lmz9", CommonFunc.convertDoubleToString(lmz9));
        result.put("lmz10", CommonFunc.convertDoubleToString(lmz10));
        result.put("lmz11", CommonFunc.convertDoubleToString(lmz11));
        result.put("lmz12", CommonFunc.convertDoubleToString(lmz12));
        result.put("lmz13", CommonFunc.convertDoubleToString(lmz13));
        result.put("lmz14", CommonFunc.convertDoubleToString(lmz14));
        result.put("lmz15", CommonFunc.convertDoubleToString(lmz15));
        result.put("lmz16", CommonFunc.convertDoubleToString(lmz16));
        result.put("lmz17", CommonFunc.convertDoubleToString(lmz17));
        result.put("lmz18", CommonFunc.convertDoubleToString(lmz18));
        result.put("lmz19", CommonFunc.convertDoubleToString(lmz19));
        result.put("lmz20", CommonFunc.convertDoubleToString(lmz20));
        result.put("lmz21", CommonFunc.convertDoubleToString(lmz21));
        ...
        result.put("acx16", CommonFunc.convertDoubleToString(acx16));
        result.put("acx17", CommonFunc.convertDoubleToString(acx17));
        result.put("acx18", CommonFunc.convertDoubleToString(acx18));
        result.put("acx19", CommonFunc.convertDoubleToString(acx19));
        result.put("acx20", CommonFunc.convertDoubleToString(acx20));
        result.put("acx21", CommonFunc.convertDoubleToString(acx21));
        ...
        result.put("atx16", CommonFunc.convertDoubleToString(atx16));
        result.put("atx17", CommonFunc.convertDoubleToString(atx17));
        result.put("atx18", CommonFunc.convertDoubleToString(atx18));
        result.put("atx19", CommonFunc.convertDoubleToString(atx19));
        result.put("atx20", CommonFunc.convertDoubleToString(atx20));
        result.put("atx21", CommonFunc.convertDoubleToString(atx21));
...
//        result.put("m3f", CommonFunc.convertDoubleToString(m3f));
        ...
        result.put("hgf16", CommonFunc.convertDoubleToString(hgf16));
        result.put("hgf17", CommonFunc.convertDoubleToString(hgf17));
        result.put("hgf18", CommonFunc.convertDoubleToString(hgf18));
        result.put("hgf19", CommonFunc.convertDoubleToString(hgf19));
        result.put("hgf20", CommonFunc.convertDoubleToString(hgf20));
        result.put("hgf21", CommonFunc.convertDoubleToString(hgf21));

        result.put("lmzf1", CommonFunc.convertDoubleToString(lmzf1));
        result.put("lmzf2", CommonFunc.convertDoubleToString(lmzf2));
        result.put("lmzf3", CommonFunc.convertDoubleToString(lmzf3));
        result.put("lmzf4", CommonFunc.convertDoubleToString(lmzf4));
        result.put("lmzf5", CommonFunc.convertDoubleToString(lmzf5));
        result.put("lmzf6", CommonFunc.convertDoubleToString(lmzf6));
        result.put("lmzf7", CommonFunc.convertDoubleToString(lmzf7));
        result.put("lmzf8", CommonFunc.convertDoubleToString(lmzf8));
        result.put("lmzf9", CommonFunc.convertDoubleToString(lmzf9));
        result.put("lmzf10", CommonFunc.convertDoubleToString(lmzf10));
        result.put("lmzf11", CommonFunc.convertDoubleToString(lmzf11));
        result.put("lmzf12", CommonFunc.convertDoubleToString(lmzf12));
        result.put("lmzf13", CommonFunc.convertDoubleToString(lmzf13));
        result.put("lmzf14", CommonFunc.convertDoubleToString(lmzf14));
        result.put("lmzf15", CommonFunc.convertDoubleToString(lmzf15));
        result.put("lmzf16", CommonFunc.convertDoubleToString(lmzf16));
        result.put("lmzf17", CommonFunc.convertDoubleToString(lmzf17));
        result.put("lmzf18", CommonFunc.convertDoubleToString(lmzf18));
        result.put("lmzf19", CommonFunc.convertDoubleToString(lmzf19));
        result.put("lmzf20", CommonFunc.convertDoubleToString(lmzf20));
        result.put("lmzf21", CommonFunc.convertDoubleToString(lmzf21));
        ...
        result.put("afcx16", CommonFunc.convertDoubleToString(afcx16));
        result.put("afcx17", CommonFunc.convertDoubleToString(afcx17));
        result.put("afcx18", CommonFunc.convertDoubleToString(afcx18));
        result.put("afcx19", CommonFunc.convertDoubleToString(afcx19));
        result.put("afcx20", CommonFunc.convertDoubleToString(afcx20));
        result.put("afcx21", CommonFunc.convertDoubleToString(afcx21));
        ...
        result.put("aftx16", CommonFunc.convertDoubleToString(aftx16));
        result.put("aftx17", CommonFunc.convertDoubleToString(aftx17));
        result.put("aftx18", CommonFunc.convertDoubleToString(aftx18));
        result.put("aftx19", CommonFunc.convertDoubleToString(aftx19));
        result.put("aftx20", CommonFunc.convertDoubleToString(aftx20));
        result.put("aftx21", CommonFunc.convertDoubleToString(aftx21));

        result.put("yxjgaz", CommonFunc.convertDoubleToString(aftx15));
        result.put("dcgssp", CommonFunc.convertDoubleToString(aftx16));
        result.put("grugssp", CommonFunc.convertDoubleToString(aftx17));
        ...
        result.put("wddzxs4", CommonFunc.convertDoubleToString(wddzxs4));
    ...
    private Map<String, Double> createDoublePDF(String language) {
        Map<String, Double> result = new HashMap();
            ...
            result.put("ma18", ma18);
            result.put("ma19", ma19);
            ...
            result.put("mtxw16", mtxw16);
            result.put("mtxw17", mtxw17);
            result.put("mtxw18", mtxw18);
            result.put("mtxw19", mtxw19);
            result.put("mtxw20", mtxw20);
            result.put("mtxw21", mtxw21);
            ...
            result.put("mfhl16", mfhl16);
            result.put("mfhl17", mfhl17);
            result.put("mfhl18", mfhl18);
            result.put("mfhl19", mfhl19);
            result.put("mfhl20", mfhl20);
...
//        计算稳定性非工作状态自重产生的倾覆力矩
            ...
            result.put("mftxw16", mftxw16);
            result.put("mftxw17", mftxw17);
            result.put("mftxw18", mftxw18);
            result.put("mftxw19", mftxw19);
            result.put("mftxw20", mftxw20);
            result.put("mftxw21", mftxw21);
...
//            result.put("wdmb4", wdmb4);
        ...
        if (xljzsyModel.equals("常规工况")) {
            ...
            result.put("mqg16", mqg16);
            result.put("mqg17", mqg17);
            result.put("mqg18", mqg18);
            result.put("mqg19", mqg19);
            ...
            result.put("mwq16", mwq16);
            result.put("mwq17", mwq17);
            result.put("mwq18", mwq18);
            result.put("mwq19", mwq19);
            result.put("mwq20", mwq20);
            result.put("mwq21", mwq21);
            ...
            result.put("fcx16", fcx16);
            result.put("fcx17", fcx17);
            result.put("fcx18", fcx18);
            result.put("fcx19", fcx19);
            result.put("fcx20", fcx20);
            result.put("fcx21", fcx21);
            ...
            result.put("mwhz16", mwhz16);
            result.put("mwhz17", mwhz17);
            result.put("mwhz18", mwhz18);
            result.put("mwhz19", mwhz19);
            result.put("mwhz21", mwhz21);
            ...
            result.put("mhz16", mhz16);
            result.put("mhz17", mhz17);
            result.put("mhz18", mhz18);
            result.put("mhz19", mhz19);
            result.put("mhz21", mhz21);
            ...
            result.put("mql16", mql16);
            result.put("mql17", mql17);
            result.put("mql18", mql18);
            result.put("mql19", mql19);
            result.put("mql21", mql21);
            ...
            result.put("mwqf16", mwqf16);
            result.put("mwqf17", mwqf17);
            result.put("mwqf18", mwqf18);
            result.put("mwqf19", mwqf19);
            result.put("mwqf20", mwqf20);
            result.put("mwqf21", mwqf21);
            ...
            result.put("ffcx16", ffcx16);
            result.put("ffcx17", ffcx17);
            result.put("ffcx18", ffcx18);
            result.put("ffcx19", ffcx19);
            result.put("ffcx20", ffcx20);
            result.put("ffcx21", ffcx21);
            ...
            result.put("mwhzf16", mwhzf16);
            result.put("mwhzf17", mwhzf17);
            result.put("mwhzf18", mwhzf18);
            result.put("mwhzf19", mwhzf19);
            result.put("mwhzf21", mwhzf21);
            ...
            //0°工作状态自重及载荷产生的倾覆力矩
            Double mjzwtsqg = jzwts * lslqg * 10 ;
            Double mshlqg = tshl * lshlqg * 10 * 1.4 ;
            Double mqg1 = m1 * lqg1 * 10 ;
            Double mqg2 = m2 * lqg2 * 10 ;
            Double mqg3 = m3 * lqg3 * 10 ;
            Double mqg4 = m4 * lqg4 * 10 ;
            Double mqg6 = m6 * lqg6 * 10 ;
            Double mqg20 = m20 * lqg20 * 10 ;
            result.put("mjzwtsqg", mjzwtsqg);
            result.put("mshlqg", mshlqg);
            result.put("mqg1", mqg1);
            result.put("mqg2", mqg2);
            result.put("mqg3", mqg3);
            ...
            //工作状态风载荷产生的水平倾覆力矩
            Double mqg5 = m5 * lqg5 * 10 ;
            Double mqg7 = m7 * lqg7 * 10 ;
            Double mqg8 = m8 * lqg8 * 10 ;
            Double mqg9 = m9 * lqg9 * 10 ;
            Double mqg10 = m10 * lqg10 * 10 ;
            Double mqg11 = m11 * lqg11 * 10 ;
            Double mqg12 = m12 * lqg12 * 10 ;
            Double mqg13 = m13 * lqg13 * 10 ;
            Double mqg14 = m14 * lqg14 * 10 ;
            Double mqg15 = m15 * lqg15 * 10 ;
            Double mqg16 = m16 * lqg16 * 10 ;
            Double mqg17 = m17 * lqg17 * 10 ;
            Double mqg18 = m18 * lqg18 * 10 ;
            Double mqg19 = m19 * lqg19 * 10 ;
            Double mqg21 = m21 * lqg21 * 10 ;
            result.put("mqg5", mqg5);
            result.put("mqg7", mqg7);
            result.put("mqg8", mqg8);
            result.put("mqg9", mqg9);
            ...
            //工作状态风载荷产生的水平倾覆力
            Double mwqsl = p * aslcx * hslg ;
            Double mwqshl = p * ashlcx * hshlg ;
            Double mwq1 = p * acx1 * hg1 ;
            Double mwq2 = p * acx2 * hg2 ;
            Double mwq3 = p * acx3 * hg3 ;
            Double mwq4 = p * acx4 * hg4 ;
            Double mwq5 = p * acx5 * hg5 ;
            Double mwq6 = p * acx6 * hg6 ;
            Double mwq7 = p * acx7 * hg7 ;
            Double mwq8 = p * acx8 * hg8 ;
            Double mwq9 = p * acx9 * hg9 ;
            Double mwq10 = p * acx10 * hg10 ;
            Double mwq11 = p * acx11 * hg11 ;
            Double mwq12 = p * acx12 * hg12 ;
            Double mwq13 = p * acx13 * hg13 ;
            Double mwq14 = p * acx14 * hg14 ;
            Double mwq15 = p * acx15 * hg15 ;
            Double mwq16 = p * acx16 * hg16 ;
            Double mwq17 = p * acx17 * hg17 ;
            Double mwq18 = p * acx18 * hg18 ;
            Double mwq19 = p * acx19 * hg19 ;
            Double mwq20 = p * acx20 * hg20 ;
            Double mwq21 = p * acx21 * hg21 ;
            result.put("mwqsl", mwqsl);
            result.put("mwqshl", mwqshl);
            result.put("mwq1", mwq1);
            result.put("mwq2", mwq2);
            ...
            //0°轮压值计算
            Double mqqg = mjzwtsqg + mshlqg + mqg1 + mqg2 + mqg3 + mqg4 + mqg6 + mqg20 ;
            Double mkqg = mqg5 + mqg7 + mqg8 + mqg9 + mqg10 + mqg11 + mqg12 + mqg13 + mqg14 + mqg15 + mqg16 + mqg17 + mqg18 + mqg19 + mqg20 + mqg21 ;
            Double mwq = mwqsl + mwqshl + mwq1 + mwq2 + mwq3 + mwq4 + mwq5 + mwq6 + mwq7 + mwq8 + mwq9 + mwq10 + mwq11 + mwq12 + mwq13 + mwq14 + mwq15 + mwq16 + mwq17 + mwq18 + mwq19 + mwq20 + mwq21 ;
            Double mfqg = mkqg - mqqg ;
            Double vcd = mfqg / lg / 2 ;
            Double vab = jzmzj * 10 / 2 - vcd ;
//        Double mgq = 2 * 0.064 * mzj * gxh ;
            Double msq = mwq ;
            Double dtv1 = msq / ll / 2 ;
            Double av1 = vab - dtv1 ;
...
//        result.put("mgq", mgq);
            ...
            Double fcx12 = p * acx12 ;
            Double fcx13 = p * acx13 ;
            Double fcx14 = p * acx14 ;
            Double fcx15 = p * acx15 ;
            Double fcx16 = p * acx16 ;
            Double fcx17 = p * acx17 ;
            Double fcx18 = p * acx18 ;
            Double fcx19 = p * acx19 ;
            Double fcx20 = p * acx20 ;
            Double fcx21 = p * acx21 ;
            result.put("fslcx", fslcx);
            result.put("fshlcx", fshlcx);
            result.put("fcx1", fcx1);
            result.put("fcx2", fcx2);
            ...
            //45°工作状态自重及载荷产生的倾覆力矩
            Double mjzwtshz = jzwts * lslhz * 10 ;
            Double mshlhz = tshl * lshlhz * 10 * 1.4 ;
            Double mhz1 = m1 * lhz1 * 10 ;
            Double mhz2 = m2 * lhz2 * 10 ;
            Double mhz3 = m3 * lhz3 * 10 ;
            Double mhz4 = m4 * lhz4 * 10 ;
            Double mhz5 = m5 * lhz5 * 10 ;
            Double mhz6 = m6 * lhz6 * 10 ;
            Double mhz7 = m7 * lhz7 * 10 ;
            Double mhz8 = m8 * lhz8 * 10 ;
            Double mhz20 = m20 * lhz20 * 10 ;
            result.put("mjzwtshz", mjzwtshz);
            result.put("mshlhz", mshlhz);
            result.put("mhz1", mhz1);
            result.put("mhz2", mhz2);
            result.put("mhz3", mhz3);
            ...
            //45°工作状态自重产生的抗倾覆力矩
            Double mhz9 = m9 * lhz9 * 10 ;
            Double mhz10 = m10 * lhz10 * 10 ;
            Double mhz11 = m11 * lhz11 * 10 ;
            Double mhz12 = m12 * lhz12 * 10 ;
            Double mhz13 = m13 * lhz13 * 10 ;
            Double mhz14 = m14 * lhz14 * 10 ;
            Double mhz15 = m15 * lhz15 * 10 ;
            Double mhz16 = m16 * lhz16 * 10 ;
            Double mhz17 = m17 * lhz17 * 10 ;
            Double mhz18 = m18 * lhz18 * 10 ;
            Double mhz19 = m19 * lhz19 * 10 ;
            Double mhz21 = m21 * lhz21 * 10 ;
            result.put("mhz9", mhz9);
            result.put("mhz10", mhz10);
            result.put("mhz11", mhz11);
            result.put("mhz12", mhz12);
            ...
            //45°轮压值计算
            Double mqhz = mjzwtshz + mshlhz + mhz1 + mhz2 + mhz3 + mhz4 + mhz5 + mhz6 + mhz7 + mhz8 + mhz20 ;
            Double mkhz = mhz9 + mhz10 + mhz11 + mhz12 + mhz13 + mhz14 + mhz15 + mhz16 + mhz17 + mhz18 + mhz19 + mhz21 ;
            Double vm = jzmzj * 10 / 4 ;
            Double mfhz = mqhz - mkhz ;
            Double mfhzx = mfhz * 0.707 ;
            Double mfhzy = mfhz * 0.707 ;
            Double dtvx = mfhzx / ll / 2 ;
            ...
            //90°工作状态自重及载荷产生的倾覆力矩
            Double mjzwtsql = jzwts * lslql * 10 ;
            Double mshlql = tshl * lshlql * 10 * 1.4 ;
            Double mql1 = m1 * lql1 * 10 ;
            Double mql2 = m2 * lql2 * 10 ;
            Double mql3 = m3 * lql3 * 10 ;
            Double mql4 = m4 * lql4 * 10 ;
            Double mql6 = m6 * lql6 * 10 ;
            Double mql20 = m20 * lql20 * 10 ;
            result.put("mjzwtsql", mjzwtsql);
            result.put("mshlql", mshlql);
            result.put("mql1", mql1);
            result.put("mql2", mql2);
            result.put("mql3", mql3);
            ...
            //90°工作状态自重产生的抗倾覆力矩
            Double mql5 = m5 * lql5 * 10 ;
            Double mql7 = m7 * lql7 * 10 ;
            Double mql8 = m8 * lql8 * 10 ;
            Double mql9 = m9 * lql9 * 10 ;
            Double mql10 = m10 * lql10 * 10 ;
            Double mql11 = m11 * lql11 * 10 ;
            Double mql12 = m12 * lql12 * 10 ;
            Double mql13 = m13 * lql13 * 10 ;
            Double mql14 = m14 * lql14 * 10 ;
            Double mql15 = m15 * lql15 * 10 ;
            Double mql16 = m16 * lql16 * 10 ;
            Double mql17 = m17 * lql17 * 10 ;
            Double mql18 = m18 * lql18 * 10 ;
            Double mql19 = m19 * lql19 * 10 ;
            Double mql21 = m21 * lql21 * 10 ;
            result.put("mql5", mql5);
            result.put("mql7", mql7);
            result.put("mql8", mql8);
            result.put("mql9", mql9);
            ...
            //90°轮压值计算
            Double mqql = mjzwtsql + mshlql + mql1 + mql2 + mql3 + mql4 + mql6 + mql20 ;
            Double mkql = mql5 + mql7 + mql8 + mql9 + mql10 + mql11 + mql12 + mql13 + mql14 + mql15 + mql16 + mql17 + mql18 + mql19 + mql21 ;
            Double mfql = mkql - mqql ;
            Double vad = mfql / ll / 2 ;
            Double vbc = jzmzj * 10 / 2 - vad ;
            Double dtv3 = msq / lg / 2 ;
            Double av3 = vad - dtv3 ;
            Double bv3 = vbc - dtv3 ;
            Double cv3 = vbc + dtv3 ;
    ...
    private String createSign(Double a, Double b) {
        if (a > b) {
            return ">";
        } else if (a == b) {
            return "=";
        ...
        private String createEnString(Double a, Double b) {
        if (a < b) {
            return "doesn't meet";
        } else {
            return "meets";
    ...
    private String createString(Double a, Double b) {
        if (a < b) {
            return "不满足";
        } else {
            return "满足";
...
//    }
    ...
    public Map<String, String> createMapForPDF(String language) {
            ...
            String wdlym3y = (mmh2 >= mm1p && mmh1 >= mm1) ? "meets" : "doesn't meet";
            ...
            if (xljzsyModel.equals("常规工况")) {
                ...
                resultMap.put("wdlyp1", wdlyp1);
                resultMap.put("wdlym1", "/");
                resultMap.put("wdlym1y", wdlym1y);
                resultMap.put("wdlyp2", wdlyp2);
                resultMap.put("wdlym2", "/");
                resultMap.put("wdlym3", wdlym3);
                resultMap.put("wdlym2y", wdlym2y);
                resultMap.put("wdlym3y", wdlym3y);
            }
