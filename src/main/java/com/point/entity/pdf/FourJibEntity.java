...
//            dbwjybiv = ">";
//        }
//        String dbwjymiv = (mziv <= dbm4b) ? "符合" : "不符合";
...
//        result.put("mziv", CommonFunc.convertDoubleToString(mziv));
...
//        一臂
            ...
            Double mza9i = 1.25 * 10 * m9db * lc9i;
            ...
            Double mzi = mslzai + mshlzai + mza1i + mza2i + mza3i + mza6i + mza7i + mza8i + mza9i;
...
//        二臂
            ...
            Double mza9ii = 1.25 * 10 * m9db * lc9ii;
            ...
            Double mzii = mslzaii + mshlzaii + mza1ii + mza2ii + mza3ii + mza7ii + mza8ii + mza9ii;
...
//        三臂
            ...
            Double mza9iii = 1.25 * 10 * m9db * lc9iii;
            ...
            Double mziii = mslzaiii + mshlzaiii + mza1iii + mza2iii + mza3iii + mza8iii + mza9iii;
            ...
            Double mza1iv = 1.25 * 10 * m1 * lc1iv;
            Double mza2iv = 1.25 * 10 * m2 * lc2iv;
            Double mza3iv = 1.25 * 10 * m3 * lc3iv;
            Double mza9iv = 1.25 * 10 * m9dbxt * lc9iv;
            map.put("mslzaiv", mslzaiv);
            map.put("mshlzaiv", mshlzaiv);
            map.put("mza1iv", mza1iv);
            map.put("mza2iv", mza2iv);
            map.put("mza3iv", mza3iv);
            map.put("mza9iv", mza9iv);
            ...
            Double mziv = mslzaiv + mshlzaiv + mza1iv + mza2iv + mza3iv + mza9iv;
            Double sziv = 1000 * mziv / dbwxiv;
...
//        挠度计算
            ...
            Double fx4 = mlj4 * (dbld4 * dbld4 / 2 - 2 * dbld4 * dblx4 / 3 + dblx4 * dblx4 / 6 - dblx5 * dblx5 / 6) / 210000 / dbixiii + tz * dbld4 * (dbld4 - dblx4) * (dbld4 - dblx4) / 3 / 210000 / dbixiii;
            Double fx5 = tz * dbld5 * (dbld5 - dblx5) * (dbld5 - dblx5) / 3 / 210000 / dbixiv;
//        Double o2 = mlj1 * ( dbld1 - 2 * dblx1 / 3 - 2 * dblx2 / 3 ) / 210000 / dbixls + tz * ( dbld1 * dbld1 / 2 - 2 * dbld1 * dblx1 / 3 + dblx1 * dblx1 / 6 - dblx2 * dblx2 / 6 ) / 210000 / dbixls ;
//        Double o3 = mlj2 * ( dbld2 - 2 * dblx2 / 3 - 2 * dblx3 / 3 ) / 210000 / dbixlsi + tz * ( dbld2 * dbld2 / 2 - 2 * dbld2 * dblx2 / 3 + dblx2 * dblx2 / 6 - dblx3 * dblx3 / 6 ) / 210000 / dbixlsi ;
//        Double o4 = mlj3 * ( dbld3 - 2 * dblx3 / 3 - 2 * dblx4 / 3 ) / 210000 / dbixlsii + tz * ( dbld3 * dbld3 / 2 - 2 * dbld3 * dblx3 / 3 + dblx3 * dblx3 / 6 - dblx4 * dblx4 / 6 ) / 210000 / dbixlsii ;
//        Double o5 = mlj4 * ( dbld4 - 2 * dblx4 / 3 - 2 * dblx5 / 3 ) / 210000 / dbixlsiii + tz * ( dbld4 * dbld4 / 2 - 2 * dbld4 * dblx4 / 3 + dblx4 * dblx4 / 6 - dblx5 * dblx5 / 6 ) / 210000 / dbixlsiii ;
//        Double f = fx1 + fx2 + fx3 + fx4 + fx5 + o2 * dbhd2 + o3 * dbhd3 + o4 * dbhd4 + o5 * dbhd5 ;
...
//        map.put("f", f);
            ...
            Double mza7 = 10 * m7db * lc7;
            Double mza8 = 10 * m8db * lc8;
            Double mza9 = 10 * m9db * lc9;
            map.put("mslza", mslza);
            map.put("mshlza", mshlza);
            map.put("mza1", mza1);
            map.put("mza2", mza2);
            ...
            Double mwa7 = p * acx7db * lx7;
            Double mwa8 = p * acx8db * lx8;
            Double mwa9 = p * acx9db * lx9;
            map.put("mslwa", mslwa);
            map.put("mshlwa", mshlwa);
            map.put("mwa1", mwa1);
            map.put("mwa2", mwa2);
...
//        一臂
            ...
            Double mza7i = 10 * m7db * lc7i;
            Double mza8i = 10 * m8db * lc8i;
            Double mza9i = 10 * m9db * lc9i;
            map.put("mslzai", mslzai);
            map.put("mshlzai", mshlzai);
            map.put("mza1i", mza1i);
            map.put("mza2i", mza2i);
            ...
            Double mwa7i = p * acx7db * lx7i;
            Double mwa8i = p * acx8db * lx8i;
            Double mwa9i = p * acx9db * lx9i;
            map.put("mslwai", mslwai);
            map.put("mshlwai", mshlwai);
            map.put("mwa1i", mwa1i);
            map.put("mwa2i", mwa2i);
...
//        二臂
            Double mslzaii = 10 * jzwts * lslcii;
            Double mshlzaii = 1.4 * 10 * tshl * lshlcii;
            Double mza1ii = 10 * m1 * lc1ii;
            Double mza2ii = 10 * m2 * lc2ii;
            Double mza3ii = 10 * m3 * lc3ii;
            Double mza7ii = 10 * m7dbxt * lc7ii;
            Double mza8ii = 10 * m8db * lc8ii;
            Double mza9ii = 10 * m9db * lc9ii;
            map.put("mslzaii", mslzaii);
            map.put("mshlzaii", mshlzaii);
            map.put("mza1ii", mza1ii);
            map.put("mza2ii", mza2ii);
            ...
            Double mslwaii = p * aslcx * lslxii;
            Double mshlwaii = p * ashlcx * lshlxii;
            Double mwa1ii = p * acx1 * lx1ii;
            Double mwa2ii = p * acx2 * lx2ii;
            Double mwa3ii = p * acx3 * lx3ii;
            Double mwa7ii = p * acx7db * lx7ii;
            Double mwa8ii = p * acx8db * lx8ii;
            Double mwa9ii = p * acx9db * lx9ii;
            map.put("mslwaii", mslwaii);
            map.put("mshlwaii", mshlwaii);
            map.put("mwa1ii", mwa1ii);
            map.put("mwa2ii", mwa2ii);
...
//        三臂
            Double mslzaiii = 10 * jzwts * lslciii;
            Double mshlzaiii = 1.4 * 10 * tshl * lshlciii;
            Double mza1iii = 10 * m1 * lc1iii;
            Double mza2iii = 10 * m2 * lc2iii;
            Double mza3iii = 10 * m3 * lc3iii;
            Double mza8iii = 10 * m8dbxt * lc8iii;
            Double mza9iii = 10 * m9db * lc9iii;
            map.put("mslzaiii", mslzaiii);
            map.put("mshlzaiii", mshlzaiii);
            map.put("mza1iii", mza1iii);
            map.put("mza2iii", mza2iii);
            ...
            Double mslwaiii = p * aslcx * lslxiii;
            Double mshlwaiii = p * ashlcx * lshlxiii;
            Double mwa1iii = p * acx1 * lx1iii;
            Double mwa2iii = p * acx2 * lx2iii;
            Double mwa3iii = p * acx3 * lx3iii;
            Double mwa8iii = p * acx8db * lx8iii;
            Double mwa9iii = p * acx9db * lx9iii;
            map.put("mslwaiii", mslwaiii);
            map.put("mshlwaiii", mshlwaiii);
            map.put("mwa1iii", mwa1iii);
            map.put("mwa2iii", mwa2iii);
            ...
            //        四臂
            Double mslzaiv = 10 * jzwts * lslciv;
            Double mshlzaiv = 1.4 * 10 * tshl * lshlciv;
            Double mza1iv = 10 * m1 * lc1iv;
            Double mza2iv = 10 * m2 * lc2iv;
            Double mza3iv = 10 * m3 * lc3iv;
            Double mza9iv = 10 * m9dbxt * lc9iv;
            map.put("mslzaiv", mslzaiv);
            map.put("mshlzaiv", mshlzaiv);
            map.put("mza1iv", mza1iv);
            map.put("mza2iv", mza2iv);
            ...
            Double mslwaiv = p * aslcx * lslxiv;
            Double mshlwaiv = p * ashlcx * lshlxiv;
            Double mwa1iv = p * acx1 * lx1iv;
            Double mwa2iv = p * acx2 * lx2iv;
            Double mwa3iv = p * acx3 * lx3iv;
            Double mwa9iv = p * acx9db * lx9iv;
            map.put("mslwaiv", mslwaiv);
            map.put("mshlwaiv", mshlwaiv);
            map.put("mwa1iv", mwa1iv);
            map.put("mwa2iv", mwa2iv);
...
//    }
    ...
    public Map<String, String> takeStringMapForPdf(String type) {
        ...
        Double o5 = mlj4 * ( dbld4 - 2 * dblx4 / 3 - 2 * dblx5 / 3 ) / 210000 / dbixiii + tz * ( dbld4 * dbld4 / 2 - 2 * dbld4 * dblx4 / 3 + dblx4 * dblx4 / 6 - dblx5 * dblx5 / 6 ) / 210000 / dbixiii ;
        Double f = fx1 + fx2 + fx3 + fx4 + fx5 + o2 * dbhd2 + o3 * dbhd3 + o4 * dbhd4 + o5 * dbhd5 ;
        ...
        map.put("o5", CommonFunc.convertDoubleToString4(o5));
