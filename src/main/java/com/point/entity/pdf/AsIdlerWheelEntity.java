...
//        result.put("lzdlyzp5", CommonFunc.convertDoubleToString(lzdlyzp5));
    ...
    public Map<String, Double> takeDoubleMapForPdf(String type) {
        ...
        Double md5 = m5ds * ly5 * 10 * 1.25 ;
        Double md12n = m12n * ly12n * 10 * 1.25 ;
        Double md10 = m10 * ly10 * 10 * 1.25 ;
        Double md11 = m11 * ly11 * 10 * 1.25 ;
        map.put("md5", md5);
        map.put("md12n", md12n);
        map.put("md10", md10);
        map.put("md11", md11);
        ...
        Double md5i = m5dsp * lfy5i * 10 * 1.25 ;
        Double md12ni = m12n * lfy12ni * 10 * 1.25 ;
        Double md10i = m10 * lfy10i * 10 * 1.25 ;
        Double md11i = m11 * lfy11i * 10 * 1.25 ;
        map.put("md5i", md5i);
