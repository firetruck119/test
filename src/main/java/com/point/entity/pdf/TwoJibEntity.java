...
//        map.put("db2xh", CommonFunc.convertDoubleToString(db2xh));
    ...
    public Map<String, Double> takeDoubleMapForPdf(String type) {
        ...
        Double kn = dblm / dbll ;
        Double mwz = tsl + tshl + m1 + m2 + m3 + m6db + m7db ;
        Double f1 = 1.25 * mwz * 10 * dblm * dblm * dbll * ( 1 + kn ) / 3 / 210000 / dbixls ;
        Double mwq = mslwq + mshlwq + mwq1 + mwq2 + mwq3 + mwq6 + mwq7 ;
        ...
        Double mwqp = mslwq + mshlwq + mwq1 + mwq2 + mwq3 + mwq6p + mwq7 ;
        ...
        Double mwzi = tsl + tshl + m1 + m2 + m3 + m7db ;
        Double f1i = 1.25 * mwzi * 10 * dblmi * dblmi * dblli * ( 1 + kni ) / 3 / 210000 / dbixlsi ;
        Double mwqi = mslwqi + mshlwqi + mwq1i + mwq2i + mwq3i + mwq7i ;
