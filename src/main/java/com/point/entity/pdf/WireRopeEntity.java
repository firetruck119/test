...
public class WireRopeEntity {
    ...
    public Map<String, String> createMapForPdf() {
        ...
        result.put("h", CommonFunc.convertDoubleToString3(h));
        result.put("swp", CommonFunc.convertDoubleToString3(swp));
        result.put("r1", CommonFunc.convertDoubleToString3(r1));
        result.put("mwr", CommonFunc.convertDoubleToString3(mwr));
        result.put("tsl", CommonFunc.convertDoubleToString3(tsl));
        result.put("hwll", CommonFunc.convertDoubleToString3(hwll));
        result.put("hsw", CommonFunc.convertDoubleToString3(hsw));
        result.put("tshl", CommonFunc.convertDoubleToString3(tshl));
        result.put("xh1", CommonFunc.convertDoubleToString(dcgssxh));
        result.put("dcgssxh", CommonFunc.convertDoubleToString(dcgssxh));
        result.put("dcgssd", CommonFunc.convertDoubleToString3(dcgssd));
        result.put("dcgssn", CommonFunc.convertDoubleToString3(dcgssn));
        result.put("dcgssf", CommonFunc.convertDoubleToString3(dcgssf));
        result.put("dcgssp", CommonFunc.convertDoubleToString3(dcgssp));
        result.put("grugssxh", CommonFunc.convertDoubleToString(grugssxh));
        result.put("grugssd", CommonFunc.convertDoubleToString3(grugssd));
        result.put("grugssn", CommonFunc.convertDoubleToString3(grugssn));
        result.put("grugssf", CommonFunc.convertDoubleToString3(grugssf));
        ...
        result.put("gsss1", CommonFunc.convertDoubleToString3(gsss1));
        result.put("zp1p", CommonFunc.convertDoubleToString3(zp1p));
        ...
        result.put("gsss2", CommonFunc.convertDoubleToString3(gsss2));
        result.put("zp2p", CommonFunc.convertDoubleToString3(zp2p));
    ...
    public Map<String, String> createMapForPdf2() {
        ...
        result.put("gsss1p", CommonFunc.convertDoubleToString3(gsss1p));
        ...
        result.put("gsss2p", CommonFunc.convertDoubleToString3(gsss2p));
